      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              padding:
                  AppSize.insets(context, left: 12, right: 12, top: 12, bottom: 12),
              decoration: BoxDecoration(
...
/// List/grid of [ShimmerBatchCard]s matching Discover layout on web.
  ...
  Widget build(BuildContext context) {
    ...
    return ShimmerScope(
      child: ListView.separated(
        ...
        itemBuilder: (context, index) => const ShimmerBatchCard(),
      ),
    );
  }
}
